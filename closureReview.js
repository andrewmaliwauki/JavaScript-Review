...
Once completed, add a second argument that allows the function to be executed N number of times.
After the function has been called N number of times, console.log('STAHHP');

*/

function first(two, N) {
  return function() {
    if (N > 1) {
      console.log('STAHHP');
    }
...
function hello() {
  console.log("You will only see this sentence once");
}

var result = first(hello, 1);
